...
export class TaskRepository extends Repository<Task> {
  ...
  async getTasks(
    ...
    try {
      ...
      this.logger.error(
        `Failed to get tasks for user "${user.username}", DTO: ${JSON.stringify(getTasksFilterDto)}`,
        error.stack
      );
  ...
  async createTask(
    ...
    delete task.user; // does not delete from entity, but only the property 'user' from task variable
